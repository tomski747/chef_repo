...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "tomski747-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/bobmarlen"
  #   chef.validation_client_name = "bobmarlen-validator"
  #   chef.validation_key_path = ".chef/bobmarlen-validator.pem"
  # end
end
